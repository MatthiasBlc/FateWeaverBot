...
const emojis_1 = require("../../shared/constants/emojis");
...
async function main() {
    ...
    if (existingCapabilities.length === 0) {
        ...
        const capabilities = [
            ...
            },
            {
                name: "Tisser",
                emojiTag: "WEAVING",
                category: client_1.CapabilityCategory.CRAFT,
                costPA: 1,
                hasVariableCost: true,
            ...
            },
            {
                name: "Soigner",
                emojiTag: "HEALING",
                category: client_1.CapabilityCategory.SCIENCE,
                costPA: 1,
                hasVariableCost: true,
    ...
    if (existingResourceTypes.length === 0) {
        ...
        const resourceTypes = [
            {
                name: "Vivres",
                emoji: emojis_1.RESOURCES.FOOD,
                category: "base",
                description: "Ressource comestible et utilisable pour survivre",
            },
            {
                name: "Bois",
                emoji: emojis_1.RESOURCES.WOOD,
                category: "base",
                description: "Des morceaux d'arbre",
            },
            {
                name: "Minerai",
                emoji: emojis_1.RESOURCES.MINERAL,
                category: "base",
                description: "Extraits d'un filon minier",
            },
            {
                name: "Tissu",
                emoji: emojis_1.RESOURCES.FABRIC,
                category: "transformé",
                description: " ",
            },
            {
                name: "Repas",
                emoji: emojis_1.RESOURCES.PREPARED_FOOD,
                category: "transformé",
                description: "Un bon repas",
            },
            {
                name: "Cataplasme",
                emoji: emojis_1.RESOURCES.CATAPLASM,
                category: "science",
    ...
    if (existingObjectTypes.length === 0) {
        ...
        const getCapId = (emojiTag) => capabilities.find((c) => c.emojiTag === emojiTag)?.id || "";
        ...
        const capacityBonusObjects = [
            {
                ...
                bonuses: [
                    { capabilityTag: "HUNT", bonusType: client_1.CapacityBonusType.LUCKY_ROLL },
                ],
            },
            {
                name: "Serpe",
                ...
                bonuses: [
                    { capabilityTag: "GATHER", bonusType: client_1.CapacityBonusType.LUCKY_ROLL },
                ],
            },
            {
                name: "Pioche",
                ...
                bonuses: [
                    { capabilityTag: "MINING", bonusType: client_1.CapacityBonusType.LUCKY_ROLL },
                ],
            },
            {
                name: "Nasse",
                ...
                bonuses: [
                    { capabilityTag: "FISH", bonusType: client_1.CapacityBonusType.LUCKY_ROLL },
                ],
            },
            {
                name: "Quenouille",
                ...
                bonuses: [
                    {
                        ...
                        bonusType: client_1.CapacityBonusType.ADMIN_INTERPRETED,
                    },
                ],
            },
            {
            ...
            },
            {
                ...
                bonuses: [
                    { capabilityTag: "COOKING", bonusType: client_1.CapacityBonusType.LUCKY_ROLL },
                ],
            },
            {
                ...
                bonuses: [
                    { capabilityTag: "HEALING", bonusType: client_1.CapacityBonusType.HEAL_EXTRA },
                ],
            },
            {
                name: "Compas",
                ...
                bonuses: [
                    {
                        ...
                        bonusType: client_1.CapacityBonusType.ENTERTAIN_BURST,
                    },
                ],
            },
        ];
        ...
        const getResourceId = (name) => resourceTypes.find((r) => r.name === name)?.id || 0;
        ...
        console.log(`✅ Total: ${simpleObjects.length +
            skillBonusObjects.length +
            capacityBonusObjects.length +
            resourceBagObjects.length} objets créés`);
    }
    else {
        console.log(`✅ ${existingObjectTypes.length} types d'objets déjà présents`);
    }
    ...
    if (existingLootEntries.length === 0) {
        ...
        console.log(`✅ ${lootTablePA1.length + lootTablePA2.length} entrées de loot de pêche créées`);
    }
    else {
        console.log(`✅ ${existingLootEntries.length} entrées de loot de pêche déjà présentes`);
    }
